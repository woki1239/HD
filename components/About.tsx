        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          <div className="lg:w-1/2">
             <motion.div 
               ...
               className="relative"
             >
                <div className="absolute -inset-4 bg-gradient-to-r from-blue-600 to-cyan-500 rounded-2xl blur-lg opacity-30" />
          ...
          <div className="lg:w-1/2">
            ...
            <div className="mt-10 flex gap-4">
              <div className="h-16 w-1 bg-blue-500" />
              <div className="text-slate-500 italic text-sm max-w-sm">
                {t.about.quote}
              </div>
            </div>
          </div>
